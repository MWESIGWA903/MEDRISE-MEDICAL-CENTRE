...
export const ListQueueResponseItem = zod.object({
  ...
  "status": zod.enum(['waiting', 'in-consultation', 'nursing', 'theatre', 'done', 'skipped']),
  "arrivalOrder": zod.number(),
  "staffId": zod.number().nullish(),
  "staffName": zod.string().nullish(),
  "priority": zod.enum(['normal', 'non-urgent', 'urgent', 'emergency', 'deceased']),
  ...
  "triageNursingNotes": zod.string().nullish(),
...
export const AddToQueueBody = zod.object({
  ...
  "priority": zod.enum(['normal', 'non-urgent', 'urgent', 'emergency', 'deceased']).optional(),
  ...
  "triageNursingNotes": zod.string().optional(),
...
export const UpdateQueueEntryBody = zod.object({
  "status": zod.enum(['waiting', 'in-consultation', 'nursing', 'theatre', 'done', 'skipped']).optional(),
  "priority": zod.enum(['normal', 'non-urgent', 'urgent', 'emergency', 'deceased']).optional(),
  "staffId": zod.number().nullish(),
  "notes": zod.string().optional(),
  "department": zod.string().optional(),
...
export const CreateAppointmentBody = zod.object({
  ...
  "phone": zod.string(),
  "email": zod.string().email().or(zod.literal('')).optional(),
...
export const UpdatePatientBody = zod.object({
  "fullName": zod.string().min(updatePatientBodyFullNameMin).optional(),
  "phone": zod.string().optional(),
  "email": zod.string().optional(),
  "dateOfBirth": zod.string().optional(),
  "age": zod.number().optional(),
 ...
 */
export const ListImagingOrdersQueryParams = zod.object({
  "patientId": zod.coerce.number().optional(),
  "status": zod.coerce.string().optional(),
  "modality": zod.coerce.string().optional()
})

export const ListImagingOrdersResponseItem = zod.object({
  "id": zod.number(),
  "patientId": zod.number(),
  "patientName": zod.string().nullish(),
  "patientDob": zod.string().nullish(),
  "consultationId": zod.number().nullish(),
  "queueEntryId": zod.number().nullish(),
  "requestedBy": zod.number().nullish(),
  "requestedByName": zod.string().nullish(),
  "modality": zod.string(),
  "bodyPart": zod.string().nullish(),
  "clinicalIndication": zod.string().nullish(),
  "priority": zod.enum(['routine', 'urgent', 'stat']),
  "status": zod.enum(['requested', 'in-progress', 'completed', 'cancelled']),
...
export const ListImagingOrdersResponse = zod.array(ListImagingOrdersResponseItem)


/**
 * @summary Create a new imaging order
 */
export const CreateImagingOrderBody = zod.object({
  "patientId": zod.number(),
  "consultationId": zod.number().optional(),
  "requestedBy": zod.number().optional(),
  "modality": zod.string(),
  "bodyPart": zod.string().optional(),
  "clinicalIndication": zod.string().optional(),
  "priority": zod.enum(['routine', 'urgent', 'stat']).optional(),
  "notes": zod.string().optional()
})
 ...
 */
export const UpdateImagingOrderParams = zod.object({
  "id": zod.coerce.number()
})

export const UpdateImagingOrderBody = zod.object({
  "status": zod.enum(['requested', 'in-progress', 'completed', 'cancelled']).optional(),
...
export const UpdateImagingOrderResponse = zod.object({
  "id": zod.number(),
  "patientId": zod.number(),
  "patientName": zod.string().nullish(),
  "patientDob": zod.string().nullish(),
 ...
 */
export const DeleteImagingOrderParams = zod.object({
  "id": zod.coerce.number()
})
 ...
 */
export const ListHmisTargetsQueryParams = zod.object({
  "periodType": zod.enum(['daily', 'weekly', 'monthly', 'yearly']).optional()
})

export const ListHmisTargetsResponseItem = zod.object({
  "id": zod.number(),
  "metricKey": zod.string(),
  "periodType": zod.enum(['daily', 'weekly', 'monthly', 'yearly']),
  "targetValue": zod.number(),
  "updatedBy": zod.number().nullish(),
  "updatedAt": zod.string()
})
export const ListHmisTargetsResponse = zod.array(ListHmisTargetsResponseItem)


/**
 * @summary Upsert HMIS targets (admin/owner/medical_director only)
 */
export const upsertHmisTargetsBodyTargetsItemTargetValueMin = 0;



export const UpsertHmisTargetsBody = zod.object({
  "targets": zod.array(zod.object({
  "metricKey": zod.string(),
  "periodType": zod.enum(['daily', 'weekly', 'monthly', 'yearly']),
  "targetValue": zod.number().min(upsertHmisTargetsBodyTargetsItemTargetValueMin)
}))
})

export const UpsertHmisTargetsResponseItem = zod.object({
  "id": zod.number(),
  "metricKey": zod.string(),
  "periodType": zod.enum(['daily', 'weekly', 'monthly', 'yearly']),
  "targetValue": zod.number(),
...
export const UpsertHmisTargetsResponse = zod.array(UpsertHmisTargetsResponseItem)
...
export const ListNotificationsResponseItem = zod.object({
  "id": zod.number(),
  "type": zod.enum(['appointment', 'lab_order', 'pharmacy_stock', 'queue']),
  "title": zod.string(),
  "body": zod.string(),
