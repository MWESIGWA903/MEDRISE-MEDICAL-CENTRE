...
import type {
  ...
  ListHmisTargetsParams,
  ListImagingOrdersParams,
  ListInvoicesParams,
  ListLabOrdersParams,
...
export const updateStaff = async (id: number,
  ...
  return customFetch<StaffMember>(getUpdateStaffUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(staffUpdateInput)
  }
);}
...
export const createVitals = async (vitalSignsInput: VitalSignsInput, options?: RequestInit): Promise<VitalSigns> => {
  ...
  return customFetch<VitalSigns>(getCreateVitalsUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(vitalSignsInput)
  }
);}
...
export const updateLabOrder = async (id: number,
  ...
  return customFetch<LabOrder>(getUpdateLabOrderUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(labOrderUpdateInput)
  }
);}
...
export const getListImagingOrdersUrl = (params?: ListImagingOrdersParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/imaging/orders?${stringifiedParams}` : `/api/imaging/orders`
}

/**
 * @summary List imaging orders
 */
export const listImagingOrders = async (params?: ListImagingOrdersParams, options?: RequestInit): Promise<ImagingOrder[]> => {

  return customFetch<ImagingOrder[]>(getListImagingOrdersUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListImagingOrdersQueryKey = (params?: ListImagingOrdersParams,) => {
    return [
    `/api/imaging/orders`, ...(params ? [params] : [])
    ] as const;
    }


export const getListImagingOrdersQueryOptions = <TData = Awaited<ReturnType<typeof listImagingOrders>>, TError = ErrorType<unknown>>(params?: ListImagingOrdersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listImagingOrders>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListImagingOrdersQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listImagingOrders>>> = ({ signal }) => listImagingOrders(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listImagingOrders>>, TError, TData> & { queryKey: QueryKey }
}

export type ListImagingOrdersQueryResult = NonNullable<Awaited<ReturnType<typeof listImagingOrders>>>
export type ListImagingOrdersQueryError = ErrorType<unknown>
...
export function useListImagingOrders<TData = Awaited<ReturnType<typeof listImagingOrders>>, TError = ErrorType<unknown>>(
 params?: ListImagingOrdersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listImagingOrders>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListImagingOrdersQueryOptions(params,options)
...
export const getCreateImagingOrderUrl = () => {




  return `/api/imaging/orders`
}

/**
 * @summary Create a new imaging order
 */
export const createImagingOrder = async (imagingOrderInput: ImagingOrderInput, options?: RequestInit): Promise<ImagingOrder> => {

  return customFetch<ImagingOrder>(getCreateImagingOrderUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(imagingOrderInput)
  }
);}
...
export const getCreateImagingOrderMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createImagingOrder>>, TError,{data: BodyType<ImagingOrderInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createImagingOrder>>, TError,{data: BodyType<ImagingOrderInput>}, TContext> => {

const mutationKey = ['createImagingOrder'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createImagingOrder>>, {data: BodyType<ImagingOrderInput>}> = (props) => {
          const {data} = props ?? {};

          return  createImagingOrder(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateImagingOrderMutationResult = NonNullable<Awaited<ReturnType<typeof createImagingOrder>>>
    export type CreateImagingOrderMutationBody = BodyType<ImagingOrderInput>
    export type CreateImagingOrderMutationError = ErrorType<unknown>

    /**
 * @summary Create a new imaging order
 */
export const useCreateImagingOrder = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createImagingOrder>>, TError,{data: BodyType<ImagingOrderInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createImagingOrder>>,
        TError,
        {data: BodyType<ImagingOrderInput>},
        TContext
      > => {
      return useMutation(getCreateImagingOrderMutationOptions(options));
    }

export const getUpdateImagingOrderUrl = (id: number,) => {




  return `/api/imaging/orders/${id}`
}

/**
 * @summary Update an imaging order (status, findings, impression)
 */
export const updateImagingOrder = async (id: number,
    imagingOrderUpdateInput: ImagingOrderUpdateInput, options?: RequestInit): Promise<ImagingOrder> => {

  return customFetch<ImagingOrder>(getUpdateImagingOrderUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(imagingOrderUpdateInput)
  }
);}
...
export const getUpdateImagingOrderMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateImagingOrder>>, TError,{id: number;data: BodyType<ImagingOrderUpdateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateImagingOrder>>, TError,{id: number;data: BodyType<ImagingOrderUpdateInput>}, TContext> => {

const mutationKey = ['updateImagingOrder'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateImagingOrder>>, {id: number;data: BodyType<ImagingOrderUpdateInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  updateImagingOrder(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateImagingOrderMutationResult = NonNullable<Awaited<ReturnType<typeof updateImagingOrder>>>
    export type UpdateImagingOrderMutationBody = BodyType<ImagingOrderUpdateInput>
    export type UpdateImagingOrderMutationError = ErrorType<void>

    /**
 * @summary Update an imaging order (status, findings, impression)
 */
export const useUpdateImagingOrder = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateImagingOrder>>, TError,{id: number;data: BodyType<ImagingOrderUpdateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateImagingOrder>>,
        TError,
        {id: number;data: BodyType<ImagingOrderUpdateInput>},
        TContext
      > => {
      return useMutation(getUpdateImagingOrderMutationOptions(options));
    }

export const getDeleteImagingOrderUrl = (id: number,) => {
...
/**
 * @summary Delete an imaging order
 */
export const deleteImagingOrder = async (id: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getDeleteImagingOrderUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteImagingOrderMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteImagingOrder>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteImagingOrder>>, TError,{id: number}, TContext> => {

const mutationKey = ['deleteImagingOrder'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteImagingOrder>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  deleteImagingOrder(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteImagingOrderMutationResult = NonNullable<Awaited<ReturnType<typeof deleteImagingOrder>>>

    export type DeleteImagingOrderMutationError = ErrorType<void>

    /**
 * @summary Delete an imaging order
 */
export const useDeleteImagingOrder = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteImagingOrder>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteImagingOrder>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getDeleteImagingOrderMutationOptions(options));
    }
...
export const updateLeaveRequest = async (id: number,
  ...
  return customFetch<LeaveRequest>(getUpdateLeaveRequestUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(leaveRequestUpdateInput)
  }
);}
...
export const getListHmisTargetsUrl = (params?: ListHmisTargetsParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/reports/targets?${stringifiedParams}` : `/api/reports/targets`
}

/**
 * @summary List all HMIS targets
 */
export const listHmisTargets = async (params?: ListHmisTargetsParams, options?: RequestInit): Promise<HmisTarget[]> => {

  return customFetch<HmisTarget[]>(getListHmisTargetsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListHmisTargetsQueryKey = (params?: ListHmisTargetsParams,) => {
    return [
    `/api/reports/targets`, ...(params ? [params] : [])
    ] as const;
    }


export const getListHmisTargetsQueryOptions = <TData = Awaited<ReturnType<typeof listHmisTargets>>, TError = ErrorType<unknown>>(params?: ListHmisTargetsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listHmisTargets>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListHmisTargetsQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listHmisTargets>>> = ({ signal }) => listHmisTargets(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listHmisTargets>>, TError, TData> & { queryKey: QueryKey }
}

export type ListHmisTargetsQueryResult = NonNullable<Awaited<ReturnType<typeof listHmisTargets>>>
export type ListHmisTargetsQueryError = ErrorType<unknown>
...
export function useListHmisTargets<TData = Awaited<ReturnType<typeof listHmisTargets>>, TError = ErrorType<unknown>>(
 params?: ListHmisTargetsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listHmisTargets>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListHmisTargetsQueryOptions(params,options)
...
export const getUpsertHmisTargetsUrl = () => {




  return `/api/reports/targets`
}

/**
 * @summary Upsert HMIS targets (admin/owner/medical_director only)
 */
export const upsertHmisTargets = async (hmisTargetUpsertInput: HmisTargetUpsertInput, options?: RequestInit): Promise<HmisTarget[]> => {

  return customFetch<HmisTarget[]>(getUpsertHmisTargetsUrl(),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(hmisTargetUpsertInput)
  }
);}
...
export const getUpsertHmisTargetsMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof upsertHmisTargets>>, TError,{data: BodyType<HmisTargetUpsertInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof upsertHmisTargets>>, TError,{data: BodyType<HmisTargetUpsertInput>}, TContext> => {

const mutationKey = ['upsertHmisTargets'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof upsertHmisTargets>>, {data: BodyType<HmisTargetUpsertInput>}> = (props) => {
          const {data} = props ?? {};

          return  upsertHmisTargets(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpsertHmisTargetsMutationResult = NonNullable<Awaited<ReturnType<typeof upsertHmisTargets>>>
    export type UpsertHmisTargetsMutationBody = BodyType<HmisTargetUpsertInput>
    export type UpsertHmisTargetsMutationError = ErrorType<unknown>

    /**
 * @summary Upsert HMIS targets (admin/owner/medical_director only)
 */
export const useUpsertHmisTargets = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof upsertHmisTargets>>, TError,{data: BodyType<HmisTargetUpsertInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof upsertHmisTargets>>,
        TError,
        {data: BodyType<HmisTargetUpsertInput>},
        TContext
      > => {
      return useMutation(getUpsertHmisTargetsMutationOptions(options));
    }
...
/**
 * @summary List recent notifications for the current staff member
 */
...
/**
 * @summary Dismiss a notification for the current staff member
 */
export const dismissNotification = async (id: number, options?: RequestInit): Promise<DismissNotification200> => {

  return customFetch<DismissNotification200>(getDismissNotificationUrl(id),
  {
    ...options,
    method: 'POST'
