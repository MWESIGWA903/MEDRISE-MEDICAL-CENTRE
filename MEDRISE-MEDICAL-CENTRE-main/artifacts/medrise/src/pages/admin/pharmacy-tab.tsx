      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Dialog open={addOpen} onOpenChange={setAddOpen}>
          ...
          <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
            <DialogHeader><DialogTitle>Add Drug to Stock</DialogTitle><DialogDescription className="sr-only">Add a new drug to the pharmacy inventory.</DialogDescription></DialogHeader>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1 justify-end">
                        ...
                        <Dialog open={editItem?.id === s.id} onOpenChange={open => setEditItem(open ? { id: s.id } : null)}>
                          ...
                          <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
                            <DialogHeader><DialogTitle>Edit — {s.drugName}</DialogTitle><DialogDescription className="sr-only">Update drug stock details.</DialogDescription></DialogHeader>
      ...
      {dispenseOpen && (
        <Dialog open={!!dispenseOpen} onOpenChange={() => setDispenseOpen(null)}>
          <DialogContent className="max-w-sm">
            <DialogHeader><DialogTitle>Dispense — {dispenseOpen.name}</DialogTitle><DialogDescription className="sr-only">Record medication dispensed to a patient.</DialogDescription></DialogHeader>
