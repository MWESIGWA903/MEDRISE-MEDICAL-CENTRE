...
export default function AdminDashboard({ isStaffPortal = false }: { isStaffPortal?: boolean }) {
  ...
  const [mainTab, setMainTab] = useState<DashboardTab>(getTabFromUrl);

  const changeTab = React.useCallback((tab: DashboardTab) => {
    setMainTab(tab);
    try {
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors px-3 py-2 rounded-lg cursor-pointer border border-gray-200 dark:border-gray-700">
            ...
            {/* Hidden dialog for change password (triggered from dropdown) */}
