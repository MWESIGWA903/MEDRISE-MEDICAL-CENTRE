            ...
            <div className="ml-auto">
              <Dialog open={addShiftOpen} onOpenChange={setAddShiftOpen}>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader><DialogTitle>Assign Shift</DialogTitle><DialogDescription className="sr-only">Assign a work shift to a staff member.</DialogDescription></DialogHeader>
          ...
          <div className="flex gap-3 mb-4 flex-wrap items-center">
            ...
            <div className="ml-auto">
              <Dialog open={addLeaveOpen} onOpenChange={setAddLeaveOpen}>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader><DialogTitle>Submit Leave Request</DialogTitle><DialogDescription className="sr-only">Submit a leave request for a staff member.</DialogDescription></DialogHeader>
