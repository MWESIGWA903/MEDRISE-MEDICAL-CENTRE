        ...
        <div className="flex items-center gap-3">
          ...
          <Dialog open={addOpen} onOpenChange={setAddOpen}>
            ...
            <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
              <DialogHeader><DialogTitle>New Lab Order</DialogTitle><DialogDescription className="sr-only">Create a new laboratory test order for a patient.</DialogDescription></DialogHeader>
                  ...
                  <div className="px-4 pb-4 border-t border-gray-50 pt-3">
                    ...
                    <Button
                      ...
                      onClick={() => printLabResult({
                        ...
                        orderedTime: new Date(String(order.orderedAt)).toLocaleTimeString("en-UG", { hour: "2-digit", minute: "2-digit" }),
      ...
      {resultOpen && (
        <Dialog open={!!resultOpen} onOpenChange={() => setResultOpen(null)}>
          <DialogContent className="max-w-md">
            <DialogHeader><DialogTitle>Record Result — {resultOpen.testName}</DialogTitle><DialogDescription className="sr-only">Enter the laboratory test result for this order.</DialogDescription></DialogHeader>
