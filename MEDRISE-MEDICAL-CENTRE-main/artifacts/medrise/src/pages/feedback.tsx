      ...
      <section className="bg-primary/5 py-16 border-b border-primary/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Your feedback helps us improve our services. We value every opinion — thank you for
            taking a moment to share yours.
          </p>
        </div>
      </section>
            ...
            {success ? (
              <div className="bg-green-50 border border-green-200 text-green-800 p-12 rounded-xl text-center shadow-sm">
                ...
                <p className="text-lg mb-8">
                  ...
                  experience at MEDRISE MEDICAL CENTRE.
                </p>
                <Button
                  onClick={() => {
                    setSuccess(false);
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(v) => handleChange('wouldRecommend', v)}
                      >
                        <SelectTrigger className="h-12">
