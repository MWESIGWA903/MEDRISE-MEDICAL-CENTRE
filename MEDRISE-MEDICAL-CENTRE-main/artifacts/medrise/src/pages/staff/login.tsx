...
export default function StaffLogin() {
  ...
  const onResetRequest = async (values: z.infer<typeof resetRequestSchema>) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Enter the token below to reset your password.',
      });
    } catch {
      toast({
        title: 'Error',
  ...
  const onResetConfirm = async (values: z.infer<typeof resetConfirmSchema>) => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: 'Could not reset password. Try again.',
        variant: 'destructive',
      });
    } finally {
      setResetPending(false);
        ...
        <div className="bg-teal-600 p-8 text-center text-white flex flex-col items-center">
          <div className="mb-4">
            <img
              ...
              className="h-14 w-auto max-w-[260px] object-contain object-center block mx-auto"
            />
          </div>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">
              Reset your account password using your username and a reset token.
            </DialogDescription>
          </DialogHeader>
          {resetStep === 'request' ? (
            <Form {...resetRequestForm}>
              <form onSubmit={resetRequestForm.handleSubmit(onResetRequest)} className="space-y-4">
                <p className="text-sm text-gray-500">
                  Enter your username and a reset token will be generated.
                </p>
                <FormField
