    ...
    createAppointment.mutate(
      {
        data: {
          ...
          message:
            [values.age ? `Age: ${values.age} ${values.ageUnit}` : '', values.message]
              .filter(Boolean)
              .join(' | ') || undefined,
        },
      },
      ...
      <section className="bg-primary/5 py-16 border-b border-primary/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Schedule your visit online. Fill out the form below and we will confirm your appointment
            shortly.
          </p>
        </div>
      </section>
            ...
            {success ? (
              <div className="bg-green-50 border border-green-200 text-green-800 p-12 rounded-xl text-center shadow-sm">
                ...
                <p className="text-lg mb-8">
                  Thank you for booking with MEDRISE MEDICAL CENTRE. We have received your request
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder="medrisemedicalcentre@gmail.com"
                                type="email"
                                className="h-12"
                                {...field}
                              />
