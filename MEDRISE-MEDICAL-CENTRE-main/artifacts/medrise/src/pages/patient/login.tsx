      ...
      const match =
        ...
        data.find(
          (p: { phone: string; dateOfBirth: string | null }) =>
            p.phone.replace(/\D/g, '') === phone.replace(/\D/g, '') && p.dateOfBirth === dob,
        );
      if (match) {
        ...
        setError(
          'No patient record found with that phone number and date of birth. Please contact the clinic.',
        );
      }
    } catch {
          ...
          <Card className="shadow-lg border-0">
            <CardHeader className="pb-4">
              ...
              <p className="text-sm text-gray-500">
                Use the phone number and date of birth you registered with.
              </p>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100 text-center">
                <p className="text-xs text-gray-500">
                  ...
                  or call us at{' '}
                  <a href="tel:+256770775268" className="text-primary font-medium">
                    +256 770 775268
                  </a>
                </p>
              </div>
