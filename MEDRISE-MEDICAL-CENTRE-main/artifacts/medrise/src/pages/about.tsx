          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                Located in the heart of Wakiso District, MEDRISE MEDICAL CENTRE is a premier
                healthcare facility committed to delivering compassionate, high-quality, and
                affordable medical care to individuals and families.
              </p>
              <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                Our clinic is equipped with modern facilities and staffed by a team of experienced
                healthcare professionals who put your well-being first. We believe that everyone
                deserves access to excellent healthcare in a welcoming and clean environment.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      To provide accessible, patient-centered healthcare services that improve the
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      To be the most trusted and preferred healthcare provider in Wakiso District,
                      Uganda and beyond.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">
                Treating every patient with empathy, kindness, and understanding.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">
                Commitment to the highest standards of medical care and clinical outcomes.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">
                Honesty, transparency, and ethical conduct in all our professional practices.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">
                Valuing the dignity, privacy, and rights of every individual we serve.
              </p>
            </div>
          </div>
        </div>
