          ...
          <div className="bg-red-600 px-6 py-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-red-100 text-sm">
                An unexpected error occurred. No patient data was lost.
              </p>
            </div>
          </div>
          <div className="p-6 space-y-4">
            ...
            {this.state.errorInfo && (
              <details className="text-xs text-gray-400 bg-gray-50 rounded p-3 max-h-32 overflow-y-auto">
                <summary className="cursor-pointer font-medium text-gray-500 mb-1">
                  Technical details
                </summary>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 text-sm text-blue-800">
              ...
              <ol className="list-decimal list-inside mt-1 space-y-1 text-xs">
                <li>
                  Click <strong>Reload Page</strong> below — this resolves 90% of UI errors.
                </li>
